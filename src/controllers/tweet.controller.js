...
const createTweet = asyncHandler(async (req, res) => {
    ...
    //     throw new ApiError(400, "Only owner can create tweets");
    // }
...
const getUserTweets = asyncHandler(async (req, res) => {
    ...
    if (tweets.length === 0){
        throw new ApiError(400, "No tweet with given userId");
    }
...
// ANOTHER METHOD OF THE SAME FUNCTION USING MONGODB PIPELINES
